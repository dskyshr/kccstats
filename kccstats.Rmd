...
# データフレーム作成
matrix <- data.frame(
  "区分" = c("認定単位","総合教育科目","専門教育科目","必修科目","選択科目","テキスト","スクーリング","対面試験","代替試験","卒論・卒試","取得単位計"),
...
sample_data <- data.frame(
    type = c("認定単位","総合教育科目","専門教育科目","卒論・卒試"),
